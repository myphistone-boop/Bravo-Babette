    ...
    <div className="pt-20 md:pt-28 pb-6 md:pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden">
          ...
          <p className="text-dark/80 text-[15px] leading-relaxed font-serif italic mb-3">
          ...
          {storyOpen && (
            <p className="text-dark/80 text-[15px] leading-relaxed mb-3">
        ...
        <div className="hidden md:block">
          <div className="text-center mb-8">
            ...
            <p className="text-dark/70 max-w-2xl mx-auto text-lg font-serif italic">
          ...
          <div className="grid grid-cols-2 gap-20 items-center mb-12">
            ...
            >
              ...
              <p className="text-dark/80 text-lg mb-8 leading-relaxed font-serif italic">
              ...
              <p className="text-dark/80 text-lg mb-12 leading-relaxed">
                Chez Brunch&Co, nous ne nous contentons pas de cuisiner ; nous célébrons chaque ingrédient. Notre équipe est composée de passionnés qui partagent une vision commune : offrir une expérience sensorielle complète, où chaque détail compte.
              </p>
